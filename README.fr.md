...
- **Prix dans les souhaits** : prix Steam actuel et badge de réduction sur chaque jeu de la liste de souhaits, avec une alerte au démarrage quand des jeux sont en promotion.
